...
<body>
	...
	<section>
		...
		<%
			...
			try{
				String sql = "select a.productId, a.name, to_char(b.orderDate,'yyyy-mm-dd'), sum(b.orderQty), sum(b.orderQty*b.unitprice) from product0203 a, order0203 b where a.productId=b.productId group by a.productId, a.name, to_char(b.orderDate,'yyyy-mm-dd') order by  a.productId asc, to_char(b.orderDate,'yyyy-mm-dd') asc";
