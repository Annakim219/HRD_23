...
<body>
	...
	<section>
		...
		<%
			...
			try{
				String sql = "select a.productId, a.name, sum(b.orderQty), sum(b.orderQty*b.unitprice) from product0203 a, order0203 b where a.productId=b.productId group by a.productId, a.name order by a.productId asc";
				pstmt = conn.prepareStatement(sql);
				rs = pstmt.executeQuery();
				while(rs.next()){
					String productId = rs.getString(1);
					String name = rs.getString(2);
					String sum_orderQty = rs.getString(3);
					String orderSum = rs.getString(4);
					no++;
		...
		<%
			try{
				...
				<tr>
					<td colspan=3 align=center style="background: lightgray;"><b>합계</b></td>
